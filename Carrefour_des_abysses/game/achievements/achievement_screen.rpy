                ...
                for t in persistent.my_achievements:
                    ...
                    if achievement.has(t.name):
                        ...
                        frame:
                            ...
                            background Solid('#62e0ff') ## Nice bright blue/turquoise.
                        ...
                        if v.priority != 'platinum':
                            ...
                            frame:
                                ...
                                hbox:
                                    ...
                                    add 'gui/locked_achievement.webp' size (100, 100) yalign 0.5
                                    ...
                                    vbox:
                                        ...
                                        if v.priority is None:
                                            ...
                                            text "[v.name]" style 'achievements_label' color '#5f5f5fff'
                                            text "[v.message]" color '#525252ff'
                                        
                                        else:

                                            text _('???') style 'achievements_label' color '#464646ff'
...
init python:
    ...
    def passive_function():
        ...
        if len(persistent.my_achievements) >= (len(achievement_name) - 1):
            Achievement.add(achievement_name[''])
                        ...
                        if v.priority != 'platinum':
                            ...
                            frame:
                                ...
                                hbox:
                                    ...
                                    add 'gui/locked_achievement.webp' size (50, 50) yalign 0.5
                                    ...
                                    vbox:
                                        ...
                                        if v.priority is None:
                                            ...
                                            text "[v.name]" style 'achievements_label' color '#515151ff'
                                            text "[v.message]" color '#444444ff'
                                        
                                        else:
                                        
                                            text _('Hidden Achievement') style 'achievements_label' color '#5b5b5bff'
