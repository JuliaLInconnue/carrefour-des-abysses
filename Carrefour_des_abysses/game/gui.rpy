...
define gui.selected_color = '#373737'

## La couleur utilisée pour le texte d’un bouton qui ne peut pas être
## sélectionné.
define gui.insensitive_color = '#4a4a4a7f'
...
define gui.hover_muted_color = '#c0c0c0'

## Les couleurs utilisées pour les dialogues et les menus de choix.
define gui.text_color = '#3a85ff'
...
define gui.terminal_text_font = "gui/DigitTech16-Regular.ttf"
...
define gui.main_menu_background = "gui/main_menu_[splash].webp"
...
## La largeur, profond eur et les bords de la zone contenant le nom du personnage
...
define gui.choice_button_text_idle_color = '#180068'
define gui.choice_button_text_hover_color = "#ffffff"
define gui.choice_button_text_insensitive_color = '#7070707f'

## Boutons pour le terminal ######################################################
##
## Les boutons pour les choix (Choice buttons) sont utilisés dans le jeu pour
## permettre au joueur de choisir telle ou telle action, tel ou tel dialogue.

define gui.terminal_button_width = 1185
define gui.terminal_button_height = None
define gui.terminal_button_tile = False
define gui.terminal_button_borders = Borders(150, 8, 150, 8)
define gui.terminal_button_text_font = gui.terminal_text_font
define gui.terminal_button_text_size = gui.text_size
define gui.terminal_button_text_xalign = 0.5
define gui.terminal_button_text_idle_color = '#00ff3c'
define gui.terminal_button_text_hover_color = "#ffffff"
define gui.terminal_button_text_insensitive_color = '#0090567f'
...
## La position, profond eur et l’alignement du text nvl_tought (Le texte prononcé
